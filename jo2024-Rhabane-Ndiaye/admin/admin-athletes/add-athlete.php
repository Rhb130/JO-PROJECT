...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $dateNaissance = $_POST['dateNaissance']; // pas besoin de filtrer car il s'agit d'une date
    ...
    try {
        ...
        if ($statementCheck->rowCount() > 0) {
            ...
            // Requête pour ajouter un athlète avec la date de naissance
            $query = "INSERT INTO ATHLETE (nom_athlete, prenom_athlete, date_naissance, id_pays, id_genre) VALUES (:nomAthlete, :prenomAthlete, :dateNaissance, :idPays, :idGenre)";
            ...
            $statement->bindParam(":dateNaissance", $dateNaissance, PDO::PARAM_STR); // supposant que le format de date est correct
